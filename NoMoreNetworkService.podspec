...
Pod::Spec.new do |s|
  ...
  s.version          = '0.1.0'
  s.summary          = 'A short description of NoMoreNetworkService.'
...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/congncif/NoMoreNetworkService'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'congncif' => 'congnc.if@gmail.com' }
  s.source           = { :git => 'https://github.com/congncif/NoMoreNetworkService.git', :tag => s.version.to_s }
